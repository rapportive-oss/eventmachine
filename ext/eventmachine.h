...
extern "C" {
	...
	void evma_set_tls_host_cert (const unsigned long binding, const char *hostname, const char *privatekey_filename, const char *certchain_filename, const char *cipherlist);
